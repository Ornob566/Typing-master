...
classDiagram
    ...
    class GameManager {
        -state_ StateManager
        -levelLoader_ ILevelLoader
        -levels_ LevelManager
        -timer_ TimerManager
        -statsCalc_ IStatsCalculator
        -stats_ StatsManager
    ...
    GameManager o-- ILevelLoader
    GameManager o-- IStatsCalculator
    GameManager o-- IInputHandler
    GameManager *-- UIManager
 
    LevelManager o-- ILevelLoader
    StatsManager o-- IStatsCalculator
    StatsManager ..> LevelStats
 
    UIManager ..> StateManager
    UIManager ..> LevelManager
    UIManager ..> TimerManager
    UIManager ..> StatsManager
```
 
> **Rendering tip:** This diagram uses [Mermaid](https://mermaid.js.org/) syntax and renders automatically on GitHub, GitLab, and most Markdown previewers. If your viewer doesn't support Mermaid natively, paste the block at [mermaid.live](https://mermaid.live) to see the full diagram.
...
**Prompt 4 — UML Diagram Request:**
```
just add an uml diagram and don't change anything and give me readme.md code
```
...
- **UML Diagram** — Mermaid class diagram generated showing all interfaces, concrete classes, and relationships
